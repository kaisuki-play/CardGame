...
public class SkillManager : MonoBehaviour
{
    ...
    /// <param name="player"></param>
    /// <returns></returns>
    public static async Task NeedToPlayImpeccable(Player player)
    {
        await TaskManager.Instance.DontAwait();
    }
    ...
    /// <param name="player"></param>
    /// <returns></returns>
    public static async Task NeedToPlayPeach(Player player)
    {
        await TaskManager.Instance.DontAwait();
    }
    ...
    /// 死亡后
    /// </summary>
    /// <param name="damageOriginId"></param>
    /// <param name="targetId"></param>
    /// <returns></returns>
    public static async Task AfterPlayerIsDead(int damageOriginId, int targetId)
    {
        //TODO需要移到queue中的技能
        await HeroSkillManager.ActiveMaatSkill2(damageOriginId, targetId);
        await TaskManager.Instance.DontAwait();
    }
